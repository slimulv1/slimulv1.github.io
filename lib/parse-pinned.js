...
// Chịu cả `"` lẫn `'` cho attribute (phòng GitHub đổi style markup), dedupe theo tên,
// bỏ item không tên, giới hạn 6 (giới hạn pin của GitHub) — parser không bao giờ trả
// repo trùng/hư nhưng vẫn cực kỳ khó vỡ khi HTML đổi nhẹ.
export function parsePinnedHTML(html) {
  ...
  while ((m = liRe.exec(html))) {
    ...
    // chấp luôn cả absolute "https://github.com/owner/repo").
    const hrefM = li.match(
