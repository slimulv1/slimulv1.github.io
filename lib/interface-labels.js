...
export const UI = {
  ...
  gateHint: {
    en: 'the campfire is lit — come on in',
    ja: '焚き火、ついてるよ。入っておいで'
  },
  connecting: {
  ...
  // Trang 404 "không có bãi trại" (xem pages/404.js)
  notFound: {
    title: {
      en: 'No campsite here',
      ja: 'ここにはキャンプ場がないよ'
    ...
    body: {
      en: 'The trail you followed ends at the lakeside. Head back to the tent.',
      ja: 'この先の道は湖で終わっちゃうよ。テントに戻ろう。'
    },
    back: {
      en: 'Back to the tent',
      ja: 'テントに戻る'
  ...
  // Nhãn hành trình phía trên lưới project — tên sổ tay chính thức trong bộ
  routeTitle: {
    en: 'outdoor activity record',
    ja: '野外活動記録'
  }
}
