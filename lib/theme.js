...
// Font: M PLUS Rounded 1c đặt ĐẦU stack — Latin cũng render bằng font tròn/mềm
// giống chữ Nhật (en nhìn "dày + mềm", khớp hoàn toàn với ja về nét chữ lẫn
// hình học). System stack giữ phía sau làm fallback nếu webfont chưa tải xong.
const fonts = {
  heading: "'M PLUS Rounded 1c', sans-serif",
  body: "'M PLUS Rounded 1c', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, 'Hiragino Sans', 'Noto Sans JP', 'Yu Gothic', sans-serif",
